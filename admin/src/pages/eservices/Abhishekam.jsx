...
const Abhishekam = () => {
    const [items, setItems] = useState([
        { id: 'ABH-103', name: 'Karthik S', service: 'Milk Abhishekam', amount: '₹1001', date: '2026-02-20', status: 'Approved' },
        { id: 'ABH-105', name: 'Anitha R', service: 'Sandalwood Abhishekam', amount: '₹2501', date: '2026-02-25', status: 'Pending Approval' }
    ]);
    ...
    const handleApproval = async (id, isApproved) => {
        ...
        if (isApproved) {
            toast.success(`Confirmation sent for Abhishekam Booking ID: ${id}`, { id: 'abhishekam-confirm' });
        } else {
            toast.success('Abhishekam booking cancelled', { id: 'abhishekam-cancel' });
        }
    ...
    const columns = [
        ...
        { key: 'service', label: 'Abhishekam Type', sortable: true },
    ...
    return (
        <div className="space-y-6">
            <div>
                <h2 className="text-2xl font-serif font-bold text-gray-900">Abhishekam Bookings</h2>
                <p className="text-gray-600 mt-1">Manage online Abhishekam schedules and devotee bookings.</p>
            </div>
            <DataTable data={items} columns={columns} exportFileName="Abhishekam_Export" searchPlaceholder="Search ID, Devotee, Type..." filterOptions={filterOptions} />
        </div>
    );
};

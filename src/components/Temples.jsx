        ...
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          >
            {language === 'en' ? (
              ...
              <>
                நான்கு கோவில்கள், ஒவ்வொன்றும் தனித்துவமான முக்கியத்துவத்துடன், <span className="text-[#5d1712] font-medium">கொங்கு வேளாளர் பூந்துறை காடை கூட்டத்தின்</span> ஆன்மீக மையத்தை உருவாக்குகின்றன
              </>
            )}
          </motion.p>
        </div>

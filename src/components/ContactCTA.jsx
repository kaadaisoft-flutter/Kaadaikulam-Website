  ...
  return (
    <section className="py-20 bg-[#fdf5e6]/50 border-t border-[#c49a3c]/10">
      <div className="container mx-auto px-6 text-center">
        ...
        >
          <button className="group relative bg-[#c49a3c]/90 text-[#5d1712] px-10 py-3 rounded-xl font-bold flex items-center gap-3 mx-auto shadow-md transition-all duration-300 hover:bg-[#c49a3c] hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0">
            {t.link}
